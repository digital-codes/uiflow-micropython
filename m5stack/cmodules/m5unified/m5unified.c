...
static const mp_rom_map_elem_t m5_board_member_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_M5Stack),         MP_ROM_INT(1) },
    { MP_ROM_QSTR(MP_QSTR_M5StackCore2),    MP_ROM_INT(2) },
    { MP_ROM_QSTR(MP_QSTR_M5StickC),        MP_ROM_INT(3) },
    { MP_ROM_QSTR(MP_QSTR_M5StickCPlus),    MP_ROM_INT(4) },
    { MP_ROM_QSTR(MP_QSTR_M5StickCPlus2),   MP_ROM_INT(5) },
    ...
    { MP_ROM_QSTR(MP_QSTR_M5Tab5),          MP_ROM_INT(22) },
    ...
    { MP_ROM_QSTR(MP_QSTR_M5PaperMono),     MP_ROM_INT(29) },
    { MP_ROM_QSTR(MP_QSTR_M5StopWatch),     MP_ROM_INT(30) },
    // non display boards
    { MP_ROM_QSTR(MP_QSTR_M5Atom),          MP_ROM_INT(128) },
    { MP_ROM_QSTR(MP_QSTR_M5AtomPsram),     MP_ROM_INT(129) },
    { MP_ROM_QSTR(MP_QSTR_M5AtomU),         MP_ROM_INT(130) },
    { MP_ROM_QSTR(MP_QSTR_M5Camera),        MP_ROM_INT(131) },
    { MP_ROM_QSTR(MP_QSTR_M5TimerCam),      MP_ROM_INT(132) },
    { MP_ROM_QSTR(MP_QSTR_M5StampPico),     MP_ROM_INT(133) },
    { MP_ROM_QSTR(MP_QSTR_M5StampC3),       MP_ROM_INT(134) },
    { MP_ROM_QSTR(MP_QSTR_M5StampC3U),      MP_ROM_INT(135) },
    { MP_ROM_QSTR(MP_QSTR_M5StampS3),       MP_ROM_INT(136) },
    ...
    { MP_ROM_QSTR(MP_QSTR_M5DualKey),       MP_ROM_INT(147) },
    { MP_ROM_QSTR(MP_QSTR_M5Unit_PoEP4),    MP_ROM_INT(148) },
    { MP_ROM_QSTR(MP_QSTR_M5StampS3Bat),    MP_ROM_INT(149) },
    { MP_ROM_QSTR(MP_QSTR_M5StampP4),       MP_ROM_INT(150) },
    { MP_ROM_QSTR(MP_QSTR_M5StampC5),       MP_ROM_INT(153) },
    // external displays
    { MP_ROM_QSTR(MP_QSTR_M5ATOMDisplay),   MP_ROM_INT(192) },
    { MP_ROM_QSTR(MP_QSTR_M5UnitLCD),       MP_ROM_INT(193) },
    { MP_ROM_QSTR(MP_QSTR_M5UnitOLED),      MP_ROM_INT(194) },
    { MP_ROM_QSTR(MP_QSTR_M5UnitMiniOLED),  MP_ROM_INT(195) },
    { MP_ROM_QSTR(MP_QSTR_M5UnitGLASS),     MP_ROM_INT(196) },
    { MP_ROM_QSTR(MP_QSTR_M5UnitGLASS2),    MP_ROM_INT(197) },
    { MP_ROM_QSTR(MP_QSTR_M5UnitRCA),       MP_ROM_INT(198) },
    { MP_ROM_QSTR(MP_QSTR_M5ModuleDisplay), MP_ROM_INT(199) },
...
static const mp_rom_map_elem_t mp_module_m5_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_Led),               MP_OBJ_FROM_PTR(&m5_led) },
