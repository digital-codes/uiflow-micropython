...
class ListApp(app_base.AppBase):
    ...
    def on_install(self):
        M5.Lcd.drawImage("/system/stackchan/Selection/appList_unselected.png", 5 + 62 * 3, 20 + 4)
    ...
    def on_view(self):
        M5.Lcd.drawImage("/system/stackchan/Selection/appList_selected.png", 5 + 62 * 3, 20 + 4)

        self._bg_img = widgets.Image(use_sprite=False)
        self._bg_img.set_pos(4, 20 + 4 + 56 + 4)
        self._bg_img.set_size(312, 156)
        self._bg_img.set_src("/system/stackchan/List/main.png")
        ...
        self._left_img.set_src("/system/stackchan/List/left_cursor.png")
        ...
        self._right_img.set_src("/system/stackchan/List/right_cursor.png")
