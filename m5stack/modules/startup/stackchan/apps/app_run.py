...
class RunApp(app_base.AppBase):
    ...
    def on_install(self):
        M5.Lcd.drawImage("/system/stackchan/Selection/appRun_unselected.png", 5 + 62 + 62, 20 + 4)
    ...
    def on_view(self):
        M5.Lcd.drawImage("/system/stackchan/Selection/appRun_selected.png", 5 + 62 + 62, 20 + 4)
        M5.Lcd.drawImage("/system/stackchan/Run/run.png", 4, 20 + 4 + 56 + 4)
