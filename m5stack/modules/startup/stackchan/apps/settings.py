...
class WiFiSetting(app_base.AppBase):
    ...
    def on_view(self):
        ...
        self._bg_img.set_src("/system/stackchan/Setting/wifiServer.png")
    ...
    def _select_ssid_option(self):
        self._bg_img.set_src("/system/stackchan/Setting/ssid.png")
    ...
    def _select_psk_option(self):
        self._bg_img.set_src("/system/stackchan/Setting/pass.png")
        self._ssid_label.set_text_color(0x000000, 0xFEFEFE)
    ...
    def _select_server_option(self):
        self._bg_img.set_src("/system/stackchan/Setting/server.png")
        self._ssid_label.set_text_color(0x000000, 0xFEFEFE)
        self._psk_label.set_text_color(0x000000, 0xFEFEFE)
...
_current_options = {
    100: "/system/stackchan/Setting/charge100.png",
    500: "/system/stackchan/Setting/charge500.png",
    900: "/system/stackchan/Setting/charge900.png",
    1000: "/system/stackchan/Setting/charge1000.png",
}
...
_boot_options = {
    1: "/system/stackchan/Setting/bootYes.png",
    2: "/system/stackchan/Setting/bootNo.png",
}
...
_comlink_options = {
    False: "/system/stackchan/Setting/comxDisable.png",
    True: "/system/stackchan/Setting/comxEnable.png",
}
...
_usbpower_options = {
    False: "/system/stackchan/Setting/usbInput.png",
    True: "/system/stackchan/Setting/usbOutput.png",
}
...
_buspower_options = {
    False: "/system/stackchan/Setting/busInput.png",
    True: "/system/stackchan/Setting/busOutput.png",
}
...
class SettingsApp(app_base.AppBase):
    ...
    def on_install(self):
        M5.Lcd.drawImage("/system/stackchan/Selection/setting_unselected.png", 5 + 62 * 0, 20 + 4)
    ...
    def on_view(self):
        self._origin_x = 0
        self._origin_y = 80
        M5.Lcd.drawImage("/system/stackchan/Selection/setting_selected.png", 5 + 62 * 0, 20 + 4)
        self._lcd.clear()
