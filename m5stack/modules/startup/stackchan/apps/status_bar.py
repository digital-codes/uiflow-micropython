...
_WIFI_STATUS_ICO = {
    NetworkStatus.INIT: "/system/stackchan/WiFi/wifi_empty.png",
    NetworkStatus.RSSI_GOOD: "/system/stackchan/WiFi/wifi_good.png",
    NetworkStatus.RSSI_MID: "/system/stackchan/WiFi/wifi_mid.png",
    NetworkStatus.RSSI_WORSE: "/system/stackchan/WiFi/wifi_worse.png",
    NetworkStatus.DISCONNECTED: "/system/stackchan/WiFi/wifi_disconnected.png",
}

_CLOUD_STATUS_ICOS = {
    CloudStatus.INIT: "/system/stackchan/Server/server_empty.png",
    CloudStatus.CONNECTED: "/system/stackchan/Server/Server_Green.png",
    CloudStatus.DISCONNECTED: "/system/stackchan/Server/server_error.png",
}
...
class StatusBarApp(app_base.AppBase):
    ...
    def on_view(self):
        M5.Lcd.drawImage("/system/stackchan/Title/title_blue.png", 0, 0)
    ...
    def _get_battery_src(self, battery, charging):
        ...
        if battery > 0 and battery <= 100:
            if battery < 20:
                src = (
                    "/system/stackchan/Battery/battery_Red_Charge.png"
                    if charging
                    else "/system/stackchan/Battery/battery_Red.png"
                )
            elif battery <= 100:
                src = (
                    "/system/stackchan/Battery/battery_Green_Charge.png"
                    if charging
                    else "/system/stackchan/Battery/battery_Green.png"
                )
        else:
            src = (
                "/system/stackchan/Battery/battery_Black_Charge.png"
                if charging
                else "/system/stackchan/Battery/battery_Black.png"
            )
        return src
