...
本 skill 的官方资料在 `docs/`。下方已内嵌完整文件树；先按树定位文件，再读取对应原文。常用入口：`docs/_overview.md`、`docs/get-started/_overview.md`、`docs/hardware/`、`docs/unit/`、`docs/module/`、`docs/base/`、`docs/hat/`、`docs/m5ui/_overview.md`、`docs/widgets/_overview.md`、`docs/system/`、`docs/advanced/`。
...
<!-- BEGIN_DOC_TREE -->
```text
docs/  (353 Markdown files, 22 directories; .md suffix omitted)
Rule: an entry like unit/env means docs/unit/env.md; entries ending in / are directories.
- root: _overview, COPYRIGHT
  - advanced/: _overview, camera, code_scanner, dl, image, jpg
    - usb/: _overview
      - device/: _overview, keyboard, mouse
  - base/: _overview, atom_can, atom_gps, atom_socket, audio35, display, dtu_lorawan, dtu_lorawan_rui3, dtu_nbiot
           dtu_nbiot2, dtu_nbiot2v11, echo, echo_pyramid, gpsv2, hdriver, motion, pwm, qrcode, qrcode2, rs232, rs485
           speaker, stepmotor, tfcard
  - cap/: _overview, lora1262, lora868
  - chain/: _overview, angle, chainbus, encoder, joystick, key, mono, rgb, tof, unit_bus
  - contribute/: _overview, template
  - controllers/: _overview, airq, atoms3-lite, atoms3r_cam, cardputer, coreink, dinmeter, dualkey, nesso-n1, paper
                  stackchan, stamplc, sticks3, stopwatch
  - get-started/: _overview
  - hardware/: _overview, adc, als, button, can, display, imu, ir, lora, mic, pin, pwr485, pwrcan, rotary, scd40
               sen55, sht30, speaker, touch, uart, wdt
  - hat/: _overview, adc, cardkb, dac, dac2, dlight, env, finger, heart, joyc, joystick, mini_encoder, mini_joy, ncir
  ...
  - m5ui/: _overview, arc, bar, button, buttonmatrix, calendar, canvas, chart, checkbox, dropdown, image, keyboard
           ...
           textarea, win
  - module/: 4in8out, _overview, ain4, asr, audio, bala2, cc1101, commu, dc_motor, display, dmx, dualkmeter, ecg
             encoder4_motor, fan, gateway_h2, gnss, goplus2, gps, gpsv2, grbl, hmi, lan, llm, lora, lora868_v12
             lorawan868, lorawan_rui3, lte, nbiot, odrive, plus, pm25, pps, pwrcan, qrcode, rca, relay_2, rs232
             servo2, step_motor_driver, usb, zigbee
  - quick-reference/: _overview, get-started, usb-mode
  - software/: _overview, easysocket, modbus, modbus.rtu.master, modbus.rtu.slave, modbus.tcp.client
               modbus.tcp.server, requests2, tcp.client, tcp.server, udp.client, udp.server, umqtt.default, umqtt
  - stamplc/: _overview, ac, poe
  - system/: _overview, audio, audio.player, audio.recorder, bleuart.client, bleuart, bleuart.server, m5ble, m5espnow
             power, time, wlan.ap, wlan.sta
  - tab5/: _overview, keyboard
  - unit/: _overview, ac_measure, accel, acssr, adc, adc_v11, ain4, angle, angle8, asr, audioplayer, bldc_driver, bps
           button, buzzer, bytebutton, byteswitch, can, cardkb, cardkb2, cat1cn, catch, co2, co2l, color, dac, dac2
           dcssr, dds, digi_clock, dlight, dmx, dualbutton, earth, encoder, encoder8, env, envpro, extencoder, extio
           extio2, fader, finger, fingerprint2, flash_light, gateway_h2, glass, glass2, gps_v11, grove2grove
           hall_effect, hbridge, heart, id, imu, imupro, ina226, ir, joystick, joystick2, key, kmeter, kmeter_iso
           laser_rx, laser_tx, lcd, light, limit, lora_e220, lora_e220_433, lorawan_rui3, midi, minioled, miniscale
           mq, mqtt, mqttpoe, nbiot, nbiot2, ncir, ncir2, neco, nfc, oled, op180, op90, pdm, pir, puzzle, qrcode, rca
